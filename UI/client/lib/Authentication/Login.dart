          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              CupertinoButton.filled(
                onPressed: () async {
                  // if(phone_number.text.toString().trim().length==12&&password_controller.text.toString().trim().length>5)
                  // {
                  ...
                  //     Get.snackbar('Phone number error', 'Enter 11 characters',snackPosition: SnackPosition.BOTTOM);
