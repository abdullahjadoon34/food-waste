                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        IconButton(
                            icon: Icon(Icons.fastfood_outlined,color: kTextColor,),
                            onPressed: () => {}),
                        Text(
                          'Food Orders',
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                  icon: Get.isDarkMode
                                      ? Icon(CupertinoIcons.sun_max,color: kTextColor,)
                                      : Icon(CupertinoIcons.moon,color: kTextColor,),
                                  onPressed: () => {
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                  icon: Icon(CupertinoIcons.square_arrow_right,color: kTextColor,),
                                  onPressed: () async => {
                                        prefs =
